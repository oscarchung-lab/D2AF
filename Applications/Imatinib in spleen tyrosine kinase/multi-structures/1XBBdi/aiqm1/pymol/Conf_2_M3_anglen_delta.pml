...
bond (id 32), (id 33)
set_bond stick_color, color23, (id 32), (id 33)

set_color color24,[149, 255, 0]
bond (id 32), (id 34)
set_bond stick_color, color24, (id 32), (id 34)

set_color color25,[103, 255, 0]
bond (id 34), (id 36)
set_bond stick_color, color25, (id 34), (id 36)

set_color color26,[166, 255, 0]
bond (id 34), (id 35)
set_bond stick_color, color26, (id 34), (id 35)

set_color color27,[223, 255, 0]
bond (id 43), (id 44)
set_bond stick_color, color27, (id 43), (id 44)

set_color color28,[145, 255, 0]
bond (id 44), (id 45)
set_bond stick_color, color28, (id 44), (id 45)

set_color color29,[194, 255, 0]
bond (id 44), (id 46)
set_bond stick_color, color29, (id 44), (id 46)

set_color color30,[237, 255, 0]
bond (id 44), (id 47)
set_bond stick_color, color30, (id 44), (id 47)

set_color color31,[242, 255, 0]
bond (id 48), (id 49)
set_bond stick_color, color31, (id 48), (id 49)

set_color color32,[242, 255, 0]
bond (id 49), (id 50)
set_bond stick_color, color32, (id 49), (id 50)
