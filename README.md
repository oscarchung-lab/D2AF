...
**If feasible, try to keep the critical bondings within the same fragment to evaluate its energy**, no matter which approach (**M1-M3**) is adopted! For some unclear cases, you can try to (slightly) expand the size of the concerned fragment(s) and compare the disortion energy results. 
