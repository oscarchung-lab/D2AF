...
#### <font color=Red> Warning !!! </font>xlsx files generated by preivous version (1.0.x) do not works for current draw function  *(**<font color=Blue>D2AF -d xxx.xlsx</font>**)* 
