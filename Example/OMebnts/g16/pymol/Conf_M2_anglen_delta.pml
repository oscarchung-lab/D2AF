...
bond (id 26), (id 28)
set_bond stick_color, color27, (id 26), (id 28)

set_color color28,[250, 255, 0]
bond (id 26), (id 27)
set_bond stick_color, color28, (id 26), (id 27)
...
bond (id 28), (id 32)
set_bond stick_color, color31, (id 28), (id 32)

set_color color32,[254, 255, 0]
bond (id 28), (id 31)
set_bond stick_color, color32, (id 28), (id 31)

set_color color33,[253, 255, 0]
bond (id 29), (id 34)
set_bond stick_color, color33, (id 29), (id 34)

set_color color34,[253, 255, 0]
bond (id 29), (id 33)
set_bond stick_color, color34, (id 29), (id 33)
...
bond (id 38), (id 39)
set_bond stick_color, color37, (id 38), (id 39)

set_color color38,[254, 255, 0]
bond (id 38), (id 40)
set_bond stick_color, color38, (id 38), (id 40)

set_color color39,[253, 255, 0]
bond (id 38), (id 41)
set_bond stick_color, color39, (id 38), (id 41)
