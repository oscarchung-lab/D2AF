...
bond (id 22), (id 27)
set_bond stick_color, color21, (id 22), (id 27)
...
bond (id 27), (id 28)
set_bond stick_color, color26, (id 27), (id 28)

set_color color27,[255, 248, 0]
bond (id 27), (id 29)
set_bond stick_color, color27, (id 27), (id 29)

set_color color28,[255, 239, 0]
bond (id 29), (id 31)
set_bond stick_color, color28, (id 29), (id 31)

set_color color29,[255, 245, 0]
bond (id 31), (id 32)
set_bond stick_color, color29, (id 31), (id 32)

set_color color30,[255, 250, 0]
bond (id 32), (id 34)
set_bond stick_color, color30, (id 32), (id 34)

set_color color31,[255, 251, 0]
bond (id 32), (id 33)
...
bond (id 36), (id 39)
set_bond stick_color, color33, (id 36), (id 39)

set_color color34,[255, 242, 0]
bond (id 37), (id 38)
set_bond stick_color, color34, (id 37), (id 38)

set_color color35,[255, 235, 0]
bond (id 37), (id 48)
set_bond stick_color, color35, (id 37), (id 48)
...
set_color color42,[255, 241, 0]
bond (id 44), (id 45)
set_bond stick_color, color42, (id 44), (id 45)
...
set_color color46,[255, 218, 0]
bond (id 49), (id 51)
set_bond stick_color, color46, (id 49), (id 51)

set_color color47,[255, 233, 0]
bond (id 51), (id 53)
set_bond stick_color, color47, (id 51), (id 53)

set_color color48,[255, 233, 0]
bond (id 53), (id 54)
...
set_color color50,[255, 248, 0]
bond (id 56), (id 57)
set_bond stick_color, color50, (id 56), (id 57)

set_color color51,[255, 239, 0]
bond (id 56), (id 58)
set_bond stick_color, color51, (id 56), (id 58)

set_color color52,[255, 238, 0]
bond (id 52), (id 58)
set_bond stick_color, color52, (id 52), (id 58)

set_color color53,[255, 223, 0]
bond (id 58), (id 59)
set_bond stick_color, color53, (id 58), (id 59)

set_color color54,[255, 225, 0]
bond (id 59), (id 60)
set_bond stick_color, color54, (id 59), (id 60)

set_color color55,[255, 248, 0]
bond (id 59), (id 67)
set_bond stick_color, color55, (id 59), (id 67)

set_color color56,[255, 244, 0]
bond (id 60), (id 61)
set_bond stick_color, color56, (id 60), (id 61)

set_color color57,[255, 229, 0]
bond (id 60), (id 62)
set_bond stick_color, color57, (id 60), (id 62)

set_color color58,[255, 246, 0]
bond (id 62), (id 63)
set_bond stick_color, color58, (id 62), (id 63)
...
bond (id 64), (id 65)
set_bond stick_color, color60, (id 64), (id 65)

set_color color61,[255, 255, 0]
bond (id 64), (id 66)
set_bond stick_color, color61, (id 64), (id 66)

set_color color62,[255, 251, 0]
bond (id 66), (id 67)
set_bond stick_color, color62, (id 66), (id 67)
