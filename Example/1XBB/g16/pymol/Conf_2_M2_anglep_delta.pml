...
set_color color41,[255, 238, 0]
bond (id 43), (id 48)
set_bond stick_color, color41, (id 43), (id 48)

set_color color42,[255, 238, 0]
bond (id 43), (id 44)
...
set_color color46,[255, 231, 0]
bond (id 49), (id 50)
set_bond stick_color, color46, (id 49), (id 50)

set_color color47,[255, 214, 0]
bond (id 49), (id 51)
set_bond stick_color, color47, (id 49), (id 51)

set_color color48,[255, 219, 0]
bond (id 51), (id 53)
set_bond stick_color, color48, (id 51), (id 53)

set_color color49,[255, 236, 0]
bond (id 53), (id 54)
set_bond stick_color, color49, (id 53), (id 54)
...
bond (id 54), (id 56)
set_bond stick_color, color51, (id 54), (id 56)

set_color color52,[255, 244, 0]
bond (id 56), (id 57)
set_bond stick_color, color52, (id 56), (id 57)

set_color color53,[255, 232, 0]
bond (id 56), (id 58)
set_bond stick_color, color53, (id 56), (id 58)

set_color color54,[255, 240, 0]
bond (id 52), (id 58)
set_bond stick_color, color54, (id 52), (id 58)

set_color color55,[255, 249, 0]
bond (id 58), (id 59)
set_bond stick_color, color55, (id 58), (id 59)

set_color color56,[255, 238, 0]
bond (id 59), (id 60)
set_bond stick_color, color56, (id 59), (id 60)

set_color color57,[255, 243, 0]
bond (id 59), (id 67)
set_bond stick_color, color57, (id 59), (id 67)

set_color color58,[255, 247, 0]
bond (id 60), (id 61)
set_bond stick_color, color58, (id 60), (id 61)

set_color color59,[255, 245, 0]
bond (id 60), (id 62)
set_bond stick_color, color59, (id 60), (id 62)

set_color color60,[255, 250, 0]
bond (id 62), (id 64)
set_bond stick_color, color60, (id 62), (id 64)
...
bond (id 64), (id 66)
set_bond stick_color, color62, (id 64), (id 66)

set_color color63,[255, 246, 0]
bond (id 64), (id 65)
set_bond stick_color, color63, (id 64), (id 65)

set_color color64,[255, 252, 0]
bond (id 67), (id 68)
